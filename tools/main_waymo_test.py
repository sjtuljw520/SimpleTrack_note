...
def sequence_mot(configs, data_loader: WaymoLoader, sequence_id):
...
if __name__ == '__main__':
    ...
    if args.process > 1:
        ...
        main(args.name, args.obj_type, args.config_path, args.data_folder, det_data_folder, result_folder, args.start_frame, 0, 1)
